    ...
    <div className="flex-1">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between gap-4 mb-8">
             ...
             <div className="max-w-xl mx-auto lg:mx-0 bg-white rounded-[2rem] p-6 shadow-2xl shadow-pink-500/10 border border-zinc-100 relative z-20 -mt-8 lg:-mt-130 lg:-mb-[-320px]">
               ...
               <a href="https://app.kairosng.com/jobs" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#C2185B] hover:bg-[#A3154D] text-white px-8 py-4 rounded-full font-bold text-base transition-all shadow-lg shadow-pink-500/20 cursor-pointer">
                 See all jobs
      ...
      <section className="py-20 bg-white dark:bg-zinc-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
             ...
             <a href="https://app.kairosng.com/jobs" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#C2185B] hover:bg-[#A3154D] text-white px-6 py-3 rounded-full font-bold text-sm transition-all shadow-lg shadow-pink-500/20 cursor-pointer">
               See all jobs
            ...
            {loading ? (
              ...
              publicJobs.map((job) => {
                ...
                return (
                  <a 
                    key={job.id}
                    href={`https://app.kairosng.com/jobs/${job.slug || job.id}`}
                    target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {highlightCategories.map((cat, idx) => (
              <div
                ...
                onClick={() => handleViewRoles(cat.title)}
              >
